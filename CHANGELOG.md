...
- **`verifyPackageVersion` Helper (`@vickbk/ci-tools/packages`)**: Added a utility to read package manifests and verify whether a package matches an expected version.
