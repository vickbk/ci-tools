...
describe("postReadmeComment Runner Entrypoint", () => {
  ...
  let docsModule: typeof import("@/features/docs");
  let errorModule: typeof import("@/core/errors");
  ...
  beforeEach(async () => {
    ...
    docsModule = await import("@/features/docs");
    errorModule = await import("@/core/errors");
